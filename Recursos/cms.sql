...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2017 at 07:14 AM
...
--
-- Table structure for table `asistir_evento`
--

CREATE TABLE `asistir_evento` (
  `id_asistir_evento` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `id_evento` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `asistir_evento`
--

INSERT INTO `asistir_evento` (`id_asistir_evento`, `id_usuario`, `id_evento`) VALUES
(61, 1, 2);
...
(3, 'asdf', '<p>asdfas</p>', '3the-revolution-continues-in-mr-robot-season-2-teasers-release-date-set.png\r\n', '2017-12-07 04:31:00', 'Omar', '8092366770', 1),
...
(6, 'vendo carro', '<p>Combustible:<br />Gasolina<br />Cant. de puertas:<br />2</p>\r\n<p>Llama ahora: Darina Castillo <br />Cel: 849 875 5319</p>', '6the-revolution-continues-in-mr-robot-season-2-teasers-release-date-set.png', '2017-12-07 04:44:00', 'Omar', '8092366770', 0),
(7, 'Se vende', '<p>Psta de ajedrez&nbsp;gigante</p>', '1IMG-20170312-WA0018.jpeg', '2017-12-08 05:48:00', 'Freddy', '8297406341', 0);
...
INSERT INTO `comentarios` (`id_comentario`, `comentario`, `id_noticia`) VALUES
(1, 'Wow, quien iba a decir que el chico se podria encontrar con un artista como ese.', 16),
(2, 'La humlidad de Mark b es muy grande.', 16);
...
(2, '2da', 'Prueba', '1512668822'),
(4, 'Fondos de pc', 'Fondos de Freddy en la pc', '1512713680');
...
(6, 'Una nueva', 'lol', 'adele-pop-art3.jpg', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ex tortor, finibus a nisi rhoncus, aliquet mollis tortor.</p>'),
...
(10, 'Una noticia de adele', 'ADELE', 'resoluciones-pantallas.jpg', '<p>POPART</p>'),
...
(16, 'asdf', 'asdf', '6adele-pop-art3.jpg', '<p>asdfasdf</p>');
...
--
-- Indexes for table `asistir_evento`
--
ALTER TABLE `asistir_evento`
  ADD PRIMARY KEY (`id_asistir_evento`),
...
--
-- AUTO_INCREMENT for table `asistir_evento`
--
ALTER TABLE `asistir_evento`
  MODIFY `id_asistir_evento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
--
-- AUTO_INCREMENT for table `clasificados`
--
ALTER TABLE `clasificados`
  MODIFY `id_clasificado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
-- Constraints for table `asistir_evento`
--
ALTER TABLE `asistir_evento`
  ADD CONSTRAINT `asistir_evento_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`),
  ADD CONSTRAINT `asistir_evento_ibfk_2` FOREIGN KEY (`id_evento`) REFERENCES `eventos` (`id_evento`);
